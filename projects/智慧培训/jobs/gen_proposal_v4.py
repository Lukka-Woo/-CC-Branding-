...
# ══════════════════════════════════════════════════════════════════════════════
# Cover page  （参考 URS 咨询报告风格：顶部文档标签 + 大标题 + 双栏地址块）
# ══════════════════════════════════════════════════════════════════════════════
...
def _cover(raw_doc, vesuvius_logo_path, our_logo_png_path):
    ...
    # ── Vesuvius 品牌 Logo（居中，较大尺寸，作为客户视觉标识） ──────────────
...
r1 = total_tbl.rows[1]
for c in r1.cells:
    _cell_borders(c, top=_NONE, bottom=_GRAY, left=_NONE, right=_NONE)
...
OUTPUT  = os.path.join(_DOCS, 'Vesuvius_培训平台增强建议书_v4.docx')
